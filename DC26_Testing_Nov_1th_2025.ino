...
//Change PortB value to decide if want the aggressors and victims
...
void loop() {
  ...
  if (buttonState && !buttonWasPressed && (currentTime - lastButtonPressTime > debounceDelay)) {
    ...
    lastButtonPressTime = currentTime;
        ...
        PORTB = 0x0f; //This sets PB active. This can be adjusted to change the clocks drive
